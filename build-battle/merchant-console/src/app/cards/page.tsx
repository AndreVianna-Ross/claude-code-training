import { Table, TableBody, TableCell, TableHead, TableHeaderCell, TableRoot,
            ...
            {cards.map((card) => (
              <TableRow key={card.id}>
                <TableCell>
                  ...
                  {card.category && (
                    <span className="ml-2 text-xs text-gray-500">{CARD_CATEGORY_LABELS[card.category]}</span>
                  )}
                </TableCell>
                <TableCell>{merchantById(card.merchantId)?.name ?? card.merchantId}</TableCell>
                ...
                <TableCell className="text-right"><CardActions card={card} /></TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
